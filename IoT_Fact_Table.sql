...
CREATE OR REPLACE PACKAGE BODY PKG_LOAD_IOT_FACTS AS
    ...
    BEGIN
        ...
        INSERT INTO FactIoTReading (
            DateKey, HourSlot, DeviceKey, TourKey, ReadingTypeKey, LocationKey,
    ...
    BEGIN
        ...
        INSERT INTO FactTouristMovement (
            DateKey, TourKey, CustomerKey, LocationKey,
